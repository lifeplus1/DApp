...
describe("AaveStrategy", function () {
    ...
    describe("Deployment", function () {
        it("Should deploy with correct initial values", async function () {
            const { aaveStrategy, mockUSDC, mockAUSDC, mockAavePool, mockAaveRewards, _owner, _portfolioManager } = 
    ...
    describe("Deposits", function () {
        it("Should allow portfolio manager to deposit", async function () {
            const { aaveStrategy, mockUSDC, portfolioManager, user1, _initialBalance } = 
                await loadFixture(deployAaveStrategyFixture);
    ...
    describe("Harvest", function () {
        it("Should harvest AAVE rewards", async function () {
            const { aaveStrategy, mockAaveRewards, portfolioManager, _user1 } = 
                await loadFixture(deployAaveStrategyFixture);
    ...
    describe("Admin Functions", function () {
        ...
        it("Should allow emergency withdrawal in emergency mode", async function () {
            const { aaveStrategy, mockUSDC, portfolioManager, user1, owner, _initialBalance } = 
                await loadFixture(deployAaveStrategyFixture);
